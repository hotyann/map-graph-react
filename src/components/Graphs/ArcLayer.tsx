...
function getTooltip({ object }: PickingInfo<County>): string {
  return object ? object.properties.name : '';
}

const ArcLayerSample: React.FC = ({
  strokeWidth = 1,
  mapStyle = MAP_STYLE,
}: {
  strokeWidth?: number;
  ...
  const [data, setData] = useState<County[] | undefined>(undefined);
